...
<div class = "container">
    <div class="page-header">
		<h1>Client - <small>Update</small></h1>
	</div>
...
?>
{!! Form::model($clients, array('url' => 'clients/edit')) !!}
	...
	*/
	...
	{!! Form::hidden('client_id',$clients->client_id) !!}
	{!! Form::hidden('person_id',$clients->person_id) !!}  <?php //for person id ;?>

	<div class="form-group">
		{!! Form::label('first_name', 'First Name',array('class' => 'col-sm-2 control-label')) !!} 
			<div class="col-sm-10">
				{!! Form::text('first_name',Input::old('middle_name'),array('class' => 'form-control')) !!} 
			</div>
	</div> 
	<div class="form-group">
