    ...
    <div class="col-md-6">
        ...
        <div class="form-group @if($errors->has('commission_amount')) {{'has-error'}} @endif">
            ...
            <div class="col-sm-8">
                <div class="input-group">
                    <span class="input-group-addon">$</span>
                    {!!Form::text('commission_amount', null, array('class' => 'form-control', 'id'=>'commission_amount'))!!}
                </div>
        ...
        <div class="form-group @if($errors->has('sub_total')) {{'has-error'}} @endif">
            ...
            <div class="col-sm-8">
                <div class="input-group">
                    <span class="input-group-addon">$</span>
                    {!!Form::text('sub_total', null, array('class' => 'form-control', 'id'=>'sub_total'))!!}
                </div>
        ...
        <div class="form-group @if($errors->has('gst')) {{'has-error'}} @endif">
            ...
            <div class="col-sm-8">
                <div class="input-group">
                    <span class="input-group-addon">$</span>
                    {!!Form::text('gst', null, array('class' => 'form-control', 'id'=>'gst'))!!}
                </div>
                @if($errors->has('gst'))
        ...
        <div class="form-group @if($errors->has('total_commission')) {{'has-error'}} @endif">
            {!!Form::label('total_commission', 'Total Commission *', array('class' => 'col-sm-4 control-label')) !!}
            <div class="col-sm-8">
                <div class="input-group">
                    <span class="input-group-addon">$</span>
                    {!!Form::text('total_commission', null, array('class' => 'form-control', 'id'=>'total_commission'))!!}
                </div>
        ...
        <div class="form-group @if($errors->has('payable_to_college')) {{'has-error'}} @endif">
            ...
            <div class="col-sm-8">
                <div class="input-group">
                    <span class="input-group-addon">$</span>
                    {!!Form::text('payable_to_college', null, array('class' => 'form-control', 'id'=>'payable_to_college'))!!}
                </div>
