...
class InvoiceController extends BaseController
{
    ...
    function __construct(Invoice $institute, Request $request, InvoiceDocument $document, SuperAgentInvoice $superagent, Agent $agent)
    {
    ...
    function getData()
    {
        $institutes = Invoice::leftJoin('companies', 'institutes.company_id', '=', 'companies.company_id')
        ...
        $datatable = \Datatables::of($institutes)
            ->addColumn('action', '<a data-toggle="tooltip" title="View Invoice" class="btn btn-action-box" href ="{{ route( \'tenant.institute.show\', $institution_id) }}"><i class="fa fa-eye"></i></a> <a data-toggle="tooltip" title="Invoice Documents" class="btn btn-action-box" href ="{{ route( \'tenant.institute.document\', $institution_id) }}"><i class="fa fa-file"></i></a> <a data-toggle="tooltip" title="Edit Invoice" class="btn btn-action-box" href ="{{ route( \'tenant.institute.edit\', $institution_id) }}"><i class="fa fa-edit"></i></a> <a data-toggle="tooltip" title="Delete Invoice" class="delete-user btn btn-action-box" href="{{ route( \'tenant.institute.destroy\', $institution_id) }}"><i class="fa fa-trash"></i></a>')
    ...
    {
        $courses = InvoiceCourse::join('courses', 'institute_courses.course_id', '=', 'courses.course_id')
    ...
    {
        $intakes = Invoice::join('institute_intakes', 'institute_intakes.institute_id', '=', 'institutes.institution_id')
    ...
    {
        return view('Tenant::Invoice/add');
    }
    ...
    public function show($institution_id)
    {
        ...
        return view("Tenant::Invoice/show", $data);
    }
    ...
    public function edit($institution_id)
    {
        ...
        if ($data['institute'] != null) {
            ...
            return view('Tenant::Invoice/edit', $data);
        } else
            return show_404();
    }
    ...
    {
        $data['documents'] = $this->document->getInvoiceDocuments($institution_id);
        return view("Tenant::Invoice/document", $data);
    }
