...
<?php $__env->startSection('content'); ?>
    ...
    <div class="col-xs-12">
        <div class="box box-primary">
            ...
            <?php echo Form::open(array('route' => ['application.students.storeInvoice', $application_id], 'class' => 'form-horizontal form-left')); ?>

            <?php echo $__env->make('Tenant::Student/Invoice/form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
