...
<?php $__env->startSection('content'); ?>
    ...
    <div class="col-xs-12">
        <div class="box box-primary">
            ...
            <?php echo Form::open(array('route' => ['tenant.client.payment', $client_id], 'class' => 'form-horizontal form-left')); ?>

            <?php echo $__env->make('Tenant::Client/Payment/form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
