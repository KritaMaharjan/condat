<head>
    ...
    <!-- Datatable css -->
    <link href="<?php echo e(asset('assets/plugins/datatables/dataTables.bootstrap.css')); ?>" rel="stylesheet" type="text/css"/>
    <!-- Font Awesome -->
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/skin-blue.css')); ?>">
    <!-- iCheck CSS -->
    <link href="<?php echo e(asset('assets/plugins/iCheck/square/blue.css')); ?>" rel="stylesheet" type="text/css"/>
    <link href="<?php echo e(asset('assets/plugins/iCheck/minimal/blue.css')); ?>" rel="stylesheet" type="text/css"/>
