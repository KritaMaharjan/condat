    ...
    <div class="col-xs-9">
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <a href='<?php echo e(route('tenant.application.invoice', $application->application_id)); ?>' class="btn btn-success btn-flat pull-right"><i class="glyphicon glyphicon-plus-sign"></i> Create Invoice</a>
            </div>
            <div class="box-body">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <a href="<?php echo e(route('tenant.application.payment', $application->application_id)); ?>" class="btn btn-success btn-flat pull-right"><i class="glyphicon glyphicon-plus-sign"></i> Add Payments</a>
            </div>
            <div class="box-body">
