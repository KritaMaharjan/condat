    ...
    <div class="col-xs-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <a href='<?php echo e(route('application.students.invoice', $application->application_id)); ?>'
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <a href="<?php echo e(route('application.students.payment', $application->application_id)); ?>"
