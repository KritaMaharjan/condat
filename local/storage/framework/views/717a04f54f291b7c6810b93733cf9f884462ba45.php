<div class="box-body">
    <div class="col-md-6">
        ...
        <div class="form-group">
            <?php echo Form::label('course_application_id', 'Application *', array('class' => 'col-sm-4 control-label')); ?>

            <div class="col-sm-8">
                <?php echo Form::select('course_application_id', $applications, null, array('class' => 'form-control', 'id'=>'course_application_id')); ?>
